				...
				<tr>
					...
					<td>
						...
						if ( $row->invoice_id ) {
							...
							echo '<span class="text-danger">' . esc_html__( 'Deleted', 'school-management' ) . '<br><span class="text-secondary">' . esc_html( WLSM_M_Staff_Accountant::get_invoice_title_text( $row->invoice_label ) ) . '<br><small>' . esc_html( WLSM_Config::get_money_text( $row->invoice_payable ) )  . ' ' . esc_html__( 'Payable', 'school-management' ) . '</small></span></span>';
						}
						?>
					</td>
				</tr>
